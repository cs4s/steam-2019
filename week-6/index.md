...
- [Creative Computing Unit 3: Stories Part 2](activities/creative_computing_unit_3_stories_part_2.pdf){:target="_blank"} <i class="fas fa-file-pdf session-icon"></i> 
...
- [Teens at the Castle](https://scratch.mit.edu/projects/10128197/){:target="_blank"} <i class="fas fa-link session-icon"></i>
- [Dance Party](https://scratch.mit.edu/projects/10128067/){:target="_blank"} <i class="fas fa-link session-icon"></i>
- [Hide and Seek](https://scratch.mit.edu/projects/10128368/){:target="_blank"} <i class="fas fa-link session-icon"></i>
- [Wizard Spells](https://scratch.mit.edu/projects/11829803/){:target="_blank"} <i class="fas fa-link session-icon"></i>
- [Cookie Bird](https://scratch.mit.edu/projects/229557976/){:target="_blank"} <i class="fas fa-link session-icon"></i>
...
| Visual knowledge                                           | In the session’s activities, you will apply your visual knowledge when creating digital stories in Scratch. For example, in the *Pass It On* activity you will use Sprites to represent characters and change the Backdrop when the location in the story changes. |
{: .table .table-striped .table-bordered}
